...
function CollectionUI:update(dt)
    ...
    -- Close button
    if input.isKeyJustPressed("escape") or input.isKeyJustPressed("c") then
        self:hide()
    end
end
...
function CollectionUI:getTotalInCategory(category)
    if category == "jokers" then return 40
    elseif category == "planets" then return 21
    elseif category == "warps" then return 15
    elseif category == "imprints" then return 25
    elseif category == "sculptors" then return 8
    end
    return 0
end
